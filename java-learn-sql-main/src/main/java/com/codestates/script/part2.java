...
public class part2 {
  ...
  */
  public static final String PART2_3 = "X ";
  ...
  */
  ...
  ----------------------------------------------------------------------------------------------
      TODO: Q 2-7. content의 title과 그 컨텐츠를 작성한 user의 name을 찾기 위한 SQL을 작성해주세요.
          - 저자가 없더라도, 켄턴츠의 title을 모두 찾아야합니다. 저자가 없더라도 즉 title 값을 다가져와야함
  */
  ...
  */
  public static final String PART2_8 = "SELECT content.title , user.name " +
          "From content " +
          "JOIN user " +
          "ON user.Id = content.userId" ;
  ...
  */
  public static final String PART2_10 = "INSERT INTO content(title,body,userId) VALUES('WHY','CHAECHAE', 1);";
}
